...
func_20190732h($mu, '/tmp/dummy20190732a');
...
function func_20190732h($mu_, $file_name_rss_items_)
{
...
__HEREDOC__;
    ...
    exec('node ../scripts/chartjs_node.js 900 480 ' . base64_encode(json_encode($json)) . ' ' . $file);
