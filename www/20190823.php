...
function func_20190823g($mu_)
{
    ...
    $jobs = <<< __HEREDOC__
curl -v -m 120 -H "Authorization: Bearer {$token_dropbox}" -H 'Dropbox-API-Arg: {"path": 'dummy.txt', "mode": "overwrite", "autorename": false, "mute": false}' -H "Content-Type: application/octet-stream" --data-binary @dummy.txt https://content.dropboxapi.com/2/files/upload
__HEREDOC__;
