...
function func_20190823($mu_)
{
    ...
    $jobs = <<< __HEREDOC__
curl --verbose -m 120 -X POST --compressed -F filename={$base_name} -F content=@{$file_name_} https://apidocs.zoho.com/files/v1/upload?authtoken2={$authtoken_zoho}&scope=docsapi 2>&1
__HEREDOC__;
